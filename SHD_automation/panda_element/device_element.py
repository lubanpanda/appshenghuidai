...
account['交易密码设置']='com.yourenkeji.shenghuidai:id/safety_manament_tv_state'
account['记得支付密码']='com.yourenkeji.shenghuidai:id/yi_set_pay_password_next_rl_jide'
account['忘记支付密码']='com.yourenkeji.shenghuidai:id/yi_set_pay_password_next_rl_wangji'
account['原支付密码']='com.yourenkeji.shenghuidai:id/xiugai_paypassword_oldPassword'
account['新支付密码']='com.yourenkeji.shenghuidai:id/xiugai_paypassword_newPassword'
account['就支付密码']='com.yourenkeji.shenghuidai:id/xiugai_paypassword_newPasswordAgain'
account['验证身份证']='com.yourenkeji.shenghuidai:id/wangji_paypassword_next_edt_IDCard'
account['密码-下一步']='com.yourenkeji.shenghuidai:id/wangji_paypassword_next_btn_next'
account['密码-验证码']='com.yourenkeji.shenghuidai:id/idcard_next_phonecode_edt__code'
